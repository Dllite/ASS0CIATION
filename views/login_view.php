...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>GESTION</b>ASSOCIATION</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Entrez vos informations personnels pour vous connecter</p>

      <form method="post">
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="email" placeholder="Email ou numero de téléphone">
